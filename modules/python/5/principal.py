# modules/python/5/principal.py

"""
Evaluación de homogeneidad de varianzas (multianalito).
...
Reglas:
- k < 2 : No se puede evaluar homogeneidad
- Si todos normales: Bartlett (k>=3) o Prueba F (k==2)
- Si no todos normales: Levene

Campos de salida:
prueba_homogeneidad, estadistico, p_value
"""
