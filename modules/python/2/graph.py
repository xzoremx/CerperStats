...
"""
Gráfico simplificado para Homogeneidad de Varianzas (Monoanalito)
- Intervalos de confianza Bonferroni (errorbars horizontales)
- Leyenda simple con nombres de columnas
- Adaptado al comportamiento del script Excel original
...
if len(stds) < 2:
    ...
    ax.set_title(f"IC Bonferroni — {parametro_base}")
